...
r \circ (s \circ t) \subset (r \circ s) \circ t.qed.
\end{theorem}
...
(r \circ s) \cup (r \circ t) \subset r \circ (s \cup t).qed.
\end{theorem}
...
(s^{-1}) \circ (r^{-1}) \subset (r \circ s)^{-1} (by 61).qed.
\end{lemma}
...
(s^{-1}) \circ (r^{-1}) \subset (r \circ s)^{-1}.qed.
\end{theorem}
...
then f is a set.
Proof. f \subset (\domain f \times \range f).
qed.
\end{theorem}
...
% Definition 86
% !!! This definition is false since I commented half of it !!!
\begin{definition}[86]
